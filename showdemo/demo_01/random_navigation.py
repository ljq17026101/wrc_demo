...
class NavTest():  
    def __init__(self):  
        ...
        locations['p1'] = Pose(Point(0.8, 3.5, 0.000), Quaternion(0.000, 0.000, -0.353555776603, 0.935413444863))  
        locations['p2'] = Pose(Point(0.0, 0.0, 0.000), Quaternion(0.000, 0.000, -0.501823089959, 0.864970280636))  
        ...
        while not rospy.is_shutdown():    
            ...
            if not finished_within_time:  
                ...
                if state == GoalStatus.SUCCEEDED:  
                    ...
                    os.system('play /home/intel/Desktop/showdemo/demo_01/naving.mp3')  
                else:  
